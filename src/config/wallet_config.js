...
export const cryptoTypes = {
  ...
  "bsc": [
    { networkType: 'bsc', type: 'b_Raiser', typeName: 'Raiser', name: 'BNB', token: '', symbol: bnb, symbol1: a_bnb, chainId: '0x61' },
    { networkType: 'bsc', type: 'b_WBNB', typeName: 'WBNB', name: 'WBNB', token: 'BEP20', symbol: bnb, symbol1: a_bnb, chainId: '0x61' },
    { networkType: 'bsc', type: 'b_WBTC', typeName: 'WBTC', name: 'WBTC', token: 'BEP20', symbol: wbtc, symbol1: a_wbtc, chainId: '0x61' },
    { networkType: 'bsc', type: 'b_USDT', typeName: 'USDT', name: 'USDT', token: 'BEP20', symbol: usdt, symbol1: a_usdt, chainId: '0x61' },
    { networkType: 'bsc', type: 'b_BUSD', typeName: 'BUSD', name: 'BUSD', token: 'BEP20', symbol: busd, symbol1: a_busd, chainId: '0x61' },
    { networkType: 'bsc', type: 'b_USDC', typeName: 'USDC', name: 'USDC', token: 'BEP20', symbol: usdc, symbol1: a_usdc, chainId: '0x61' },
  ],
  "arbitrum": [
    { networkType: 'arbitrum', type: 'a_Raiser', typeName: 'Raiser', name: 'ETH', token: '', symbol: eth, symbol1: a_eth, chainId: '0x66eed' },
    { networkType: 'arbitrum', type: 'a_WETH', typeName: 'WETH', name: 'WETH', token: 'ERC20', symbol: eth, symbol1: a_eth, chainId: '0x66eed' },
    { networkType: 'arbitrum', type: 'a_WBTC', typeName: 'WBTC', name: 'WBTC', token: 'ERC20', symbol: wbtc, symbol1: a_wbtc, chainId: '0x66eed' },
    { networkType: 'arbitrum', type: 's_USDC', typeName: 'USDC', name: 'USDC', token: 'ERC20', symbol: usdc, symbol1: a_usdc, chainId: '0x66eed' },
    { networkType: 'arbitrum', type: 's_USDT', typeName: 'USDT', name: 'USDT', token: 'ERC20', symbol: usdt, symbol1: a_usdt, chainId: '0x66eed' },
  ],
}
